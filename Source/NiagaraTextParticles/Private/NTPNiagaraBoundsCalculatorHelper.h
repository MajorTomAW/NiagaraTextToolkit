...
class FNTPNiagaraBoundsCalculatorHelper : public FNiagaraBoundsCalculator
{
public:

	FNTPNiagaraBoundsCalculatorHelper() = default;
	FNTPNiagaraBoundsCalculatorHelper(const FVector& InMeshExtents, const FVector& InMaxLocalMeshOffset, const FVector& InMaxWorldMeshOffset, bool bInLocalSpace)
